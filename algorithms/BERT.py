...
test = pd.read_table("test/path")

tokenizer = BertTokenizer.from_pretrained(
    "dmis-lab/biobert-base-cased-v1.2" # PubMedBERT: "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext"
)
model = BertSrcClassifier.from_pretrained(
    "./checkpoints/BioBERT_best_model", # PubMedBERT: "microsoft/BiomedNLP-PubMedBERT-base-uncased-abstract-fulltext"
